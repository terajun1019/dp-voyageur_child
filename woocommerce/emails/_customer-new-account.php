...
<?php if ( 'yes' === get_option( 'woocommerce_registration_generate_password' ) && $password_generated ) : ?>
	...
	/*printf( __( '�p�X���[�h�͎����Ő�������܂���: %s', 'kadence-woocommerce-email-designer' ), '<strong>' . esc_html( $user_pass ) . '</strong>' );*/ ?></p>
...
if ( true == $account_section ) {
	if ( true == $button_check ) {
		...
		//echo '<p>' . esc_html__( '�p�X���[�h�̕ύX�́A���O�C����̃}�C�A�J�E���g��ʂōs���܂��B', 'kadence-woocommerce-email-designer' ) . '</p>';
		//echo '<p class="btn-container"><a href="' . esc_url( wc_get_page_permalink( 'myaccount' ) ) . '" class="btn">' . esc_html__( 'View Account', 'kadence-woocommerce-email-designer' ) . '</a></p>';
	} else {
	?>
	<p><?php 
	printf( __( 'You can access your account area to view your orders and change your password here: %s.', 'kadence-woocommerce-email-designer' ), make_clickable( esc_url( wc_get_page_permalink( 'myaccount' ) ) ) ); 
	/*printf( __( '�p�X���[�h�̕ύX�́A���O�C����̃}�C�A�J�E���g��ʂōs���܂��B: %s.', 'kadence-woocommerce-email-designer' ), make_clickable( esc_url( wc_get_page_permalink( 'myaccount' ) ) ) ); */ ?> </p>
	<?php
	}
}
/**
